...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { event_id: @template.event_id, level_id: @template.level_id } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { event_id: @template.event_id, level_id: @template.level_id } }
